...
export const projects: Project[] = [
  {
    title: "Yummy Burgers",
    description: "햄버거 예약사이트 홈페이지를 구성하여 사용자가 사이트에서 버거를 주문하여 장바구니에 담고 주문까지 가능한 사이트를 구현했습니다.",
  ...
  {
    title: "Book Island",
    description: "사용자가 자유롭게 도서 리뷰를 작성하고 다른 사용자들과 소통할 수 있는 커뮤니티 기반 도서 리뷰 플랫폼입니다.",
  ...
  {
    title: "누룩 (Nurook)",
    description: "사용자가 전통주에 대한 정보를 제공받고 손쉬운 UX/UI를 통해 전통주를 검색하고 체험 예약까지 진행할 수 있는 플랫폼입니다.",
    image: "/Nurook.png",
  ...
  {
    title: "MVE",
    description: "Web3 기반의 음원 설문 플랫폼으로, 사용자는 음악에 대한 감상 설문에 참여하고 그 기록을 NFT로 발행하며 리워드를 받을 수 있는 구조입니다.",
    image: "/MVE-admin.png",
